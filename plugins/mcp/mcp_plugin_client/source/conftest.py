...
class TestResultCollector:
    ...
    def add_result(self, nodeid: str, outcome: str, duration: float):
        ...
        if "Security" in nodeid or "_sec_" in test_name.lower():
            category = "security"
        elif "Error" in nodeid or "_error_" in test_name.lower() or "test_connect_" in test_name or "test_call_tool" in test_name or "test_fetch" in test_name or "test_load" in test_name or "test_disconnect" in test_name or "test_add_server_dup" in test_name:
            category = "error"
        else:
            category = "normal"
    ...
    def generate_markdown_report(self, output_path: Path):
        ...
        report = f"""# MCP Plugin Client 测试报告
...
def pytest_sessionfinish(session, exitstatus):
    ...
    collector.generate_markdown_report(reports_dir / "TestReport_mcp_plugin_client.md")
    collector.generate_json_report(reports_dir / "TestReport_mcp_plugin_client.json")
