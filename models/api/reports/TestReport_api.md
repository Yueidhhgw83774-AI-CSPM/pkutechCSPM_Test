...
| 项目 | 值 |
|------|-----|
| 测试对象 | `app/models/api.py` |
| 测试规格 | `docs/testing/models/api_tests.md` |
| 执行时间 | 2026-03-10 17:52:21 |
| 总耗时 | 0.11s |
| 覆盖率目标 | 90% |
...
| ID | 测试名称 | 结果 | 执行时间 |
|----|---------|------|----------|
| test_process_text_file_response_minimal | ProcessTextFileResponse 最小構成 | ✅ | 0.001s |
...
| test_base64_text_request_large_content | 大きなBase64コンテンツ | ✅ | 0.007s |
...
| ID | 测试名称 | 结果 | 执行时间 |
|----|---------|------|----------|
| test_process_text_file_response_missing_required | 必須フィールド欠落 | ✅ | 0.001s |
| test_process_text_file_response_invalid_type | 無効な型 | ✅ | 0.000s |
| test_base64_text_request_missing_filename | filename欠落 | ✅ | 0.000s |
